...
public class Java8TimeTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("当前日期加2周后的日期:" + localDate1);

        System.out.println("-------");

        LocalDate localDate4 = localDate.minus(2, ChronoUnit.MONTHS);
        System.out.println("当前日期2个月后的日期:" + localDate4);
        ...
        LocalDate localDate8 = LocalDate.of(2019, 10, 17);

        //获取两个日期之间的天数
        System.out.println(ChronoUnit.DAYS.between(localDate7, localDate8));
